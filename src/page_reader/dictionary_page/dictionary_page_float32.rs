...
pub struct DictionaryPageFloat32 {
    num_values: usize,
    sorted: bool,
    type_size: usize,
    #[allow(dead_code)]
...
impl Drop for DictionaryPageFloat32 {
    fn drop(&mut self) {
...
#[allow(dead_code)]
impl std::fmt::Display for DictionaryPageFloat32 {
...
impl DictionaryPageNew for DictionaryPageFloat32 {
    #[inline(always)]
...
impl DictionaryPageFloat32 {
    pub fn new(
        page_header: &PageHeader,
        buffer: &mut dyn ByteBufferBase,
        type_size: usize,
    ) -> Result<DictionaryPageFloat32, BoltReaderError> {
...
mod tests {
    ...
    fn load_dictionary_page_float32<'a>(
        ...
        DictionaryPageFloat32::new(&page_header, buf, 4)
    }
    ...
    fn test_create_and_drop_dictionary_page() {
        ...
        let res = load_dictionary_page_float32(&mut buf);
