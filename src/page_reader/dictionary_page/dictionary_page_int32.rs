...
pub struct DictionaryPageInt32 {
    num_values: usize,
    sorted: bool,
    type_size: usize,
    #[allow(dead_code)]
...
impl Drop for DictionaryPageInt32 {
    fn drop(&mut self) {
...
#[allow(dead_code)]
impl std::fmt::Display for DictionaryPageInt32 {
...
impl DictionaryPageNew for DictionaryPageInt32 {
    #[inline(always)]
...
impl DictionaryPageInt32 {
    pub fn new(
        page_header: &PageHeader,
        buffer: &mut dyn ByteBufferBase,
        type_size: usize,
    ) -> Result<DictionaryPageInt32, BoltReaderError> {
...
mod tests {
    ...
    fn load_dictionary_page_int32<'a>(
        ...
        DictionaryPageInt32::new(&page_header, buf, 4)
    }
    ...
    fn test_create_and_drop_dictionary_page() {
        ...
        let res = load_dictionary_page_int32(&mut buf);
