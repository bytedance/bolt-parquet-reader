...
impl<'a> DataPage for PlainDataPageReaderFloat32V1<'a> {
...
mod tests {
    ...
    fn test_read_plain_data_page_float32() {
        ...
        while begin < num_values {
            ...
            verify_plain_float32_non_null_result(&result_row_range_set, &raw_bridge, None);
    ...
    fn test_read_plain_data_page_f32_with_filter() {
        ...
        while begin < num_values {
            ...
            assert!(res.is_ok());
            verify_plain_float32_non_null_result(&result_row_range_set, &raw_bridge, Some(&filter));
            begin = end;
        }
    }
    ...
    fn test_read_nullable_plain_data_page_float32() {
        ...
        while begin < num_values {
            ...
            verify_plain_float32_nullable_result(&result_row_range_set, &raw_bridge, None);
    ...
    fn test_read_nullable_plain_data_page_f32_with_filter() {
        ...
        while begin < num_values {
            ...
            assert!(res.is_ok());
            verify_plain_float32_nullable_result(&result_row_range_set, &raw_bridge, Some(&filter));
            begin = end;
        }
    }
