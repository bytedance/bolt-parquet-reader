...
pub struct PlainDataPageReaderInt32V1<'a> {
    ...
    data: Vec<i32>,
    data_with_nulls: Option<Vec<i32>>,
}
...
impl<'a> DataPage<i32> for PlainDataPageReaderInt32V1<'a> {
    ...
    fn read(
        ...
        result_bridge: &mut dyn Bridge<i32>,
...
impl<'a> PlainDataPageReaderInt32V1<'a> {
    pub fn new(
        ...
        let data_with_nulls = if has_null {
            let mut vec: Vec<i32> = Vec::with_capacity(num_values);
    ...
    pub fn read_non_null_with_filter(
        ...
        for i in start..end {
            ...
            if filter_res {
                result_bridge.append_non_null_result(self.data[i]);
            }
        }
    ...
    pub fn read_nullable_with_filter(
        ...
        for i in start..end {
            let filter_res = filter.check_i32_with_validity(data_with_nulls[i], validity[i]);
            generator.update(i + self.current_offset - offset, filter_res);
            if filter_res {
