...
impl<'a> DataPageNew for RleBpDataPageReaderInt64V1<'a> {
...
mod tests {
    ...
    fn load_dictionary_page(buf: &mut dyn ByteBufferBase) -> DictionaryPageInt64 {
